use crate::manager::{RenderRequest, RenderResponse, GetBitmapRequest, GetBitmapResponse};
...
impl SvgClient {
    ...
    /// Render an SVG
    pub async fn render_svg(&self, svg_ &str, width: Option<u32>, height: Option<u32>) -> Result<RenderResponse> {
